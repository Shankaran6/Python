...
c=0
while c < n:
    func= str(input("Please enter R for registering, L for login and E for edit"))   
    if func == "R":
    ...
    if func == "E":
        ...
        print(lastnames[num-1])
        print(numbers[num-1])
        editz= int(input("Please chose what you want to edit 1/2/3"))
